...
const SettingsSchema = z.object({
  ...
  agentOpenaiTranscriptionModel: z.string().default("gpt-4o-transcribe"),
  ...
  agentVoiceMaxAudioBytes: z.coerce.number().int().positive().default(25 * 1024 * 1024),
  ...
  agentMaxRunsPerUserPerBurstWindow: z.coerce.number().int().positive().default(60),
  agentRunBurstWindowSeconds: z.coerce.number().int().positive().default(600),
  ...
  apartmentGateApiBaseUrl: z.string().default(""),
...
export function loadSettings(env: NodeJS.ProcessEnv = process.env): Settings {
  ...
  const settings = SettingsSchema.parse({
    ...
    agentOpenaiTranscriptionModel: env.AGENT_OPENAI_TRANSCRIPTION_MODEL,
    ...
    agentVoiceMaxAudioBytes: env.AGENT_VOICE_MAX_AUDIO_BYTES,
    ...
    agentMaxRunsPerUserPerBurstWindow: env.AGENT_MAX_RUNS_PER_USER_PER_BURST_WINDOW ?? env.AGENT_MAX_RUNS_PER_USER_PER_HOUR,
    agentRunBurstWindowSeconds: env.AGENT_RUN_BURST_WINDOW_SECONDS,
    ...
    apartmentGateApiBaseUrl: env.APARTMENT_GATE_API_BASE_URL,
