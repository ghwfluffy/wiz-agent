...
const mutationVerb = "(?:add|approve|archive|cancel|change|complete|create|delete|delegate|edit|fix|implement|mark|message|move|open|publish|put|queue|record|remind|remove|rename|reply|save|schedule|send|set|start|stop|update|write)";
