...
const metadata: Record<ToolName, Pick<ToolDefinition, "access" | "risk" | "sideEffect">> = {
  ...
  list_conversation_threads: { access: "read", risk: "low", sideEffect: "none" },
  update_conversation_thread: { access: "write", risk: "low", sideEffect: "local_persistence" },
  link_conversation_thread: { access: "write", risk: "low", sideEffect: "local_persistence" },
  ...
  update_note_item: { access: "write", risk: "medium", sideEffect: "cross_app_api" },
  delete_note_item: { access: "write", risk: "medium", sideEffect: "cross_app_api" },
  ...
  update_memory_list_item: { access: "write", risk: "medium", sideEffect: "local_persistence" },
  remove_memory_list_item: { access: "write", risk: "medium", sideEffect: "local_persistence" },
