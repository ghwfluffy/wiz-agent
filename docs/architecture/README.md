...
This directory contains project-specific architecture for AI Assistant.

Use these files for domain models, workflows, app-specific technical decisions,
and approved deviations from `docs/project-standards/`.
